...
export default function ProductCard({ product }) {
  ...
  return (
    <div
      className={`bg-white rounded-lg shadow-md overflow-hidden flex flex-col justify-between relative ${
        product.isPromo ? "border-2 border-green-500" : ""
      } h-180 overflow-y-auto`}
    >
      {product.isPromo && (
